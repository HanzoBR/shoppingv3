...
<div id="all">
    ...
    <h2 class="header-aside">Painel Administrativo</h2>
	    ...
	    <div id="section">
        <h2 class="header">Gerenciar Cupons</h2>

                <div class="quadros">                              
                    <p>
                        <input value="Cadastrar Cupon" type="button" class="button" onclick="Verify('?AjaxFunctions=true&Function=managerCoupons&module=includeCoupon', 'content', 'GET');" />
                        <input value="Modificar Cupon" type="button" class="button" onclick="Verify('?AjaxFunctions=true&Function=managerCoupons&module=alterCoupon', 'content', 'GET');" />
                        <input value="Deletar Cupon" type="button" class="button" onclick="Verify('?AjaxFunctions=true&Function=managerCoupons&module=removeCoupon', 'content', 'GET');" />
                    </p>
                    <br>
                    <br> 					
                    <div id="content"></div>                                                                       
