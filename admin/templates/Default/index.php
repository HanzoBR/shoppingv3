...
<div id="all">
    ...
    <ul>
		...
		<li><a href="../">Voltar para o Shop</a></li>	
    </ul>
    </div>
    <div id="aside">
    ...
    <h2 class="header">Painel Administrativo Shop</h2>
        <br>
    	<p>Seja bem vindo &agrave; p&aacute;gina inicial do shopping, escolha uma das op&ccedil;&otilde;es no menu 
        acima ou no menu lateral para come&ccedil;ar a navegar.<br />
		<br>
		Obs : Esteja Ciente do Que está Fazendo no Seu Shopping !<br />
		<br>
        Gerencie Agora mesmo Seu Shopping , Gerenciando Itens , Kits , Cupons , Pagamentos , Logs de Compras , Etc... <br />
        <br>
