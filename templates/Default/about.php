...
<div id="all">
	...
	<div id="section">
    	<h2 class="header">Sobre o Shopping</h2>
        <br>
    	<p>O servidor <em class="red">{#TITLE}</em> disponibiliza o shop como um meio fácil para o usuário adquirir itens e serviços dentro do jogo. Este meio é fundamental para a arrecadação de dinheiro para ajudar a manter o servidor sempre online. <br><br>

        Comprando no shop, você declara estar ciente de que o servidor não se responsabiliza por itens e/ou contas que foram roubadas dentro do servidor, pois quem faz a segurança da conta é o próprio dono, sendo assim, o servidor se compromete somente a prestar suporte caso haja alguma falha no sistema.</p>
        <br><br>
    </div>
    <div id="footer">
