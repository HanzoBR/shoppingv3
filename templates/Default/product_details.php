	...
	<div id="section">
    	...
    	<div class="quadros">
                ...
                <div id="Result_Ajax_Catalog">
                    ...
                    <table border="0">
					<tr><center><img id="ProductPhoto" src="{#ProductPhoto}" style="border:none;" /></center></tr>
                    	<tr><td rowspan="9" valign="top"></td></tr>
                	<center><h1 id="ProductName">{#ProductName}</center></h>
                    <hr>					
                    	<tr><td>
                            <font color="black" size="2"><b>Obs:
                            Antes de comprar Qualquer Item, Abra o Seu Bau uma vez Pelo Menos,
							Para que Nenhum Item Bugue Ao ser Comprado no Nosso Shopping !</b></font>
							<br>
							<hr>
