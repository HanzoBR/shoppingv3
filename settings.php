...
define("RECOVERY_LIMIT_MIN_TIME", 3); //Tempo mэnimo a ser aguardado com o player offline para recuperar um item no shopping; Tempo recomendado 15 minutos. (Evitar dupers em versуo com personal store)
